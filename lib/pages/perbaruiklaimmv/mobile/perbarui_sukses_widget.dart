...
class PerbaruiSuksesWidget extends StatefulWidget {
  final String display;
  final String description;
  final String displayButton;
  final VoidCallback? onButtonPressed;

  const PerbaruiSuksesWidget({
    super.key,
  ...
  @override
  State<PerbaruiSuksesWidget> createState() => _PerbaruiSuksesWidgetState();
}

class _PerbaruiSuksesWidgetState extends State<PerbaruiSuksesWidget> {
