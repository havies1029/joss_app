...
class DetailManagementPolisPage2 extends StatefulWidget {
  final dynamic data;
  final String cobId;
  final String? jenisProses;
  final String statusId;

  const DetailManagementPolisPage2({
    super.key,
    required this.data,
    required this.cobId,
  ...
  @override
  State<DetailManagementPolisPage2> createState() =>
      _DetailManagementPolisPage2State();
}

class _DetailManagementPolisPage2State extends State<DetailManagementPolisPage2> {
  bool _loading = true;
  ...
  void _triggerByProses({
    ...
    final resolvedId = prosesId.trim();
  ...
  void _recomputeNewest() {
    ...
    for (int i = 0; i < _items.length; i++) {
      final dt = _getDateTime!(_items[i]); // DateTime?
      if (dt == null) continue;
    ...
    _newestDate = newest;
    _activeIndex = newestIndex >= 0 ? newestIndex : 0; // kalau semua null, fallback 0
  }
