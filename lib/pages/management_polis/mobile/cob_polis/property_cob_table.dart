...
class PropertyCobTable extends StatefulWidget {
  ...
  final void Function(AsetParCariModel item)? onUnselectItem;
...
class _PropertyCobTableState extends State<PropertyCobTable> {
  ...
  TableRow _detailRowWithCheckbox(
    ...
    //         '  selectedItem.hashCode= ${widget.selectedItem?.hashCode}\n'
    //         '  d.asetParId          = ${d.asetParId}\n'
    //         '  selectedItem.asetParId= ${widget.selectedItem?.asetParId}\n'
    //         '  objectEqual (==)     = ${widget.selectedItem == d}\n'
    // );
