...
//
//                   debugPrint("woy ini new ID" + regmv!);
//                   Navigator.push(
//                     context,
//                     MaterialPageRoute(
//                       builder: (context) => RegmvFormMain(recordId: state.record!.regmv1Id, viewMode: 'ubah',),
//                     ),
//                   );
//                 }else {
//                   setState(() {
...
//       if (form1ViewMode == "ubah" && form2ViewMode == "ubah"){
...
//         await calmvform1key.currentState?.saveForm1();
//       }else {
//         debugPrint("testae form1 belum ada kosong belum valid");
//         openForm1();
//       }
...
//         await calmvform2key.currentState?.saveForm2();
//       }else {
//         debugPrint("testae form2 belum ada kosong belum valid");
//
//         openForm2();
//
//       }
//       debugPrint("⚠️ Form2 belum valid → munculkan error");
//
//
//     }
//   }
