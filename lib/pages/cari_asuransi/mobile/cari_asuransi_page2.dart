...
class CariAsuransiWidget2 extends StatelessWidget {
  final CariAsuransiType type;

  const CariAsuransiWidget2({
    super.key,
    this.type = CariAsuransiType.page,
  });

  const CariAsuransiWidget2.page({super.key})
      : type = CariAsuransiType.page;

  const CariAsuransiWidget2.menu({super.key})
...
class CariAsuransiPage extends CariAsuransiWidget2 {
  const CariAsuransiPage({super.key}) : super(type: CariAsuransiType.page);
}

class CariAsuransiMenu extends CariAsuransiWidget2 {
