...
class _RegmvFormMainState extends State<RegmvFormMain> {
          ...
          children: [
            ...
            Padding(
              ...
              child: const FormSectionHeader(
                ...
                title: "Kendaraan",
                subtitle:
                "Isi detail kendaraan v, pilih pertanggungan, dan hitung premi secara otomatis.",
              ),
            ),
  ...
  Future<void> openForm4() async {
    ...
    setState(() {
      expanded = newState;
      if (expanded[3] == true) {
        regmvform4key.currentState?.onOpenedByParent();
      }
    });
  }
  ...
  Future<void> openForm5() async {
    ...
    setState(() {
      expanded = newState;
      if (expanded[4] == true) {
        regmvform5key.currentState?.onOpenedByParent();
      }
    });
  }
