...
class Regmv7StoragePickerPanel extends StatelessWidget {
  ...
  const Regmv7StoragePickerPanel({
    super.key,
    required this.items,
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          const SizedBox(height: 8),
          Text(
            "Pastikan foto Aksesoris terlihat jelas dan tidak buram untuk memudahkan proses verifikasi.",
            textAlign: TextAlign.center,
            style: TextStyle(
