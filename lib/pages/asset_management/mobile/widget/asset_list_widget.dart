...
class AssetListWidget extends FormField<ComboCobListModel?> {
  AssetListWidget({
    ...
    EdgeInsetsGeometry padding = const EdgeInsets.symmetric(vertical: 8, horizontal: hPadding),
  }) : super(
    ...
    builder: (field) {
      ...
      final textStyle = bodyTextStyle(field.context, fontSize: 16);
      final Color chipBg = pGrey; // asumsi dari constants.dart
      final Color chipSelected = primaryColor; // asumsi dari constants.dart
      final double radius = cardBorderRadius; // asumsi dari constants.dart
