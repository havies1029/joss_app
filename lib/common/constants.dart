...
const String kPassNullError = "Kata Sandi wajib diisi.";
const String kShortPassError = "Kata Sandi terlalu pendek (minimal 6 karakter).";
const String kMatchPassError = "Konfirmasi Kata Sandi tidak sama.";
