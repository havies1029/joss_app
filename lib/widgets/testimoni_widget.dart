...
class TestimonialSectionState extends State<TestimonialSection> {
  ...
  Widget _buildGridView(BuildContext context, List<ReviewCariModel> items) {
    ...
    return Padding(
      padding: const EdgeInsets.only(top: 0, bottom: 16), // ⬅️ jarak bawah section aja
      child: GridView.builder(
        shrinkWrap: true,
        physics: const NeverScrollableScrollPhysics(),
        padding: EdgeInsets.zero, // ⬅️ pastikan gak ada padding default
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
          crossAxisCount: crossAxisCount,
          crossAxisSpacing: 16,
          mainAxisSpacing: 16, // tetap 16 antar-card
