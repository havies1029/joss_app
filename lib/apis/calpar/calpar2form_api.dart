...
class Calpar2FormAPI {
  ...
  Future<ReturnDataAPI> calpar2FormUbahAPI(Calpar2FormModel record) async {
    String ubahEndpoint =
  ...
  Future<bool> calpar2FormHapusAPI(String calpar2Id) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/calpar/calpar2form/delete";
  ...
  Future<Calpar2FormModel> calpar2FormLihatAPI(String calpar1Id) async {
    String lihatEndpoint =
        "${AppData.prefixEndPoint}/api/calpar/calpar2form/read";
