...
class Regpar4FormAPI {
  ...
  Future<bool> regpar4FormHapusAPI(String regpar4Id) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/regpar/regpar4form/delete";
  ...
  Future<Regpar4FormModel> regpar4FormLihatAPI(String regpar1Id) async {
    String lihatEndpoint =
        "${AppData.prefixEndPoint}/api/regpar/regpar4form/read";
