...
class ComboMJnsbengkelAPI {

	Future<List<ComboMJnsbengkelModel>> getComboMJnsbengkelAPI() async {
		String urlGetComboEndPoint = "${AppData.prefixEndPoint}/api/mjnsbengkelcombobox/getlist";
