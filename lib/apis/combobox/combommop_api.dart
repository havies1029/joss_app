...
class ComboMMopAPI {
  Future<List<ComboMMopModel>> getComboMMopAPI(String filter) async {
    String urlGetComboEndPoint =
        "${AppData.prefixEndPoint}/api/mmopcombobox/getlist";
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<ComboMMopModel>((json) => ComboMMopModel.fromJson(json))
          .toList();
    } else {
