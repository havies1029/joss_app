...
class ComboMMvgrupOjkAPI {
  Future<List<ComboMMvgrupOjkModel>> getComboMMvgrupOjkAPI(
      String filter) async {
    String urlGetComboEndPoint =
        "${AppData.prefixEndPoint}/api/mmvgrupojkcombobox/getlist";
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<ComboMMvgrupOjkModel>(
              (json) => ComboMMvgrupOjkModel.fromJson(json))
          .toList();
    } else {
