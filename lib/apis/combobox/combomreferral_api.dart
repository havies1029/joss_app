...
class ComboMReferralAPI {
  Future<List<ComboMReferralModel>> getComboMReferralAPI(String filter) async {
    String urlGetComboEndPoint =
        "${AppData.prefixEndPoint}/api/mreferralcombobox/getlist";
    ...
    if (response.statusCode == 200) {
      ...
      return parsed
          .map<ComboMReferralModel>(
              (json) => ComboMReferralModel.fromJson(json))
          .toList();
    } else {
