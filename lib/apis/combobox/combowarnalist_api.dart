...
class ComboWarnaListAPI {

	Future<List<ComboWarnaListModel>> getComboWarnaListAPI(String filter) async {
		...
		if (response.statusCode == 200) {
			...
			return parsed
				.map<ComboWarnaListModel>((json) => ComboWarnaListModel.fromJson(json))
				.toList();
		} else {
