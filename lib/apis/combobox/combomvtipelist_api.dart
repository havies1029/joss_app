...
class ComboMvtipeListAPI {

	Future<List<ComboMvtipeListModel>> getComboMvtipeListAPI(String filter) async {
		...
		if (response.statusCode == 200) {
			...
			return parsed
				.map<ComboMvtipeListModel>((json) => ComboMvtipeListModel.fromJson(json))
				.toList();
		} else {
