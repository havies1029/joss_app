...
class Calmv1ListAPI {
  Future<List<Calmv1ListModel>> getCalmv1ListAPI(
      String searchText, int hal) async {
    String urlGetListEndPoint =
        "${AppData.prefixEndPoint}/api/calmv/calmv1list/getlist";
  ...
  Future<ReturnDataAPI> calmv2RegmvAPI(String calmv1Id) async {
    ...
    debugPrint("=== calmv2RegmvAPI CALL ===");
    debugPrint("URI       : $uri");
    ...
    debugPrint("=== calmv2RegmvAPI RESPONSE ===");
    ...
    if (response.statusCode == 200) {
      ...
      debugPrint("calmv2RegmvAPI ERROR: statusCode=${response.statusCode}");
