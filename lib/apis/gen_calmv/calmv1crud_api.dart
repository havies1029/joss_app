...
class Calmv1CrudAPI {
  ...
  Future<bool> calmv1CrudHapusAPI(String calmv1Id) async {
    String hapusEndpoint =
        "${AppData.prefixEndPoint}/api/calmv/calmv1crud/delete";
  ...
  Future<Calmv1CrudModel> calmv1CrudLihatAPI(String calmv1Id) async {
    String lihatEndpoint =
        "${AppData.prefixEndPoint}/api/calmv/calmv1crud/read";
  ...
  Future<ReturnDataAPI> calmMvToRegMvAPI(String calmv1Id) async {
    String endpoint =
        "${AppData.prefixEndPoint}/api/calmv/calmv1crud/calmvtoregmv";
