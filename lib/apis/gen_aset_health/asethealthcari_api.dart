...
class AsetHealthCariAPI{
	Future<List<AsetHealthCariModel>> getAsetHealthCariAPI(String statusId, String searchText, int hal) async {
		String urlGetListEndPoint = "${AppData.prefixEndPoint}/api/assethealth/asethealthcari/getlist";
