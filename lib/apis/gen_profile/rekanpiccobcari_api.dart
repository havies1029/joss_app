...
class RekanPicCobCariAPI{
	Future<List<RekanPicCobCariModel>> getRekanPicCobCariAPI(String rekanPicId, String searchText, int hal) async {
		String urlGetListEndPoint = "${AppData.prefixEndPoint}/api/profile/piccobcari/getlist";

		Map<String, String> queryParams = {"rekanPICId": rekanPicId, "searchText": searchText, "hal": hal.toString()};
		...
		if (response.statusCode == 200) {
			...
			return parsed
				.map<RekanPicCobCariModel>((json) => RekanPicCobCariModel.fromJson(json))
				.toList();
		} else {
