...
class KlaimprogresscariState extends Equatable {
  ...
  final String klaim1Id;
	...
	const KlaimprogresscariState.success(List<KlaimprogresscariModel> items)
			: this(status: ListStatus.success, items: items);

	const KlaimprogresscariState.failure() : this(status: ListStatus.failure);
	...
	@override
	List<Object?> get props => [status, items, hasReachedMax, klaim1Id, nilaiKlaim, jadwalBayar, klaimProgressInfo];
}
