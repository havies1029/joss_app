...
class Regmv3FormState extends Equatable {
  ...
  Regmv3FormState copyWith({
    ...
    return Regmv3FormState(
      ...
      comboMWilayah: identical(comboMWilayah, _sentinel)
          ? this.comboMWilayah
          : comboMWilayah as ComboMWilayahModel?,
      comboMMvmerk: identical(comboMMvmerk, _sentinel)
          ? this.comboMMvmerk
          : comboMMvmerk as ComboMMvmerkModel?,
      comboMMvtipe: identical(comboMMvtipe, _sentinel)
          ? this.comboMMvtipe
          : comboMMvtipe as ComboMMvtipeModel?,
      comboMMvmodel: identical(comboMMvmodel, _sentinel)
          ? this.comboMMvmodel
          : comboMMvmodel as ComboMMvmodelModel?,
      comboMWarna: identical(comboMWarna, _sentinel)
          ? this.comboMWarna
          : comboMWarna as ComboMWarnaModel?,
      comboMMvpakai: identical(comboMMvpakai, _sentinel)
          ? this.comboMMvpakai
          : comboMMvpakai as ComboMMvpakaiModel?,
    );
  }
