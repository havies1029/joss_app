...
class Regmv2FormModel {
	...
	Regmv2FormModel({required this.aw, required this.coverLama, 
		...
		required this.pll, required this.polisAkhir, 
		required this.polisMulai, required this.regmv2Id,  required this.regmv1Id,
		required this.tpl, this.currId, this.comboRMatauang, 
		this.mmvjnscoverId, this.comboMMvjnscover});
