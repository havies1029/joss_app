class Regmv6FormModel {
	...
	factory Regmv6FormModel.fromJson(Map<String, dynamic> data) {
		return Regmv6FormModel(
			...
			premiSubtotal:
			double.tryParse(data['premiSubtotal'].toString()) ?? 0,
	...
	Regmv6FormModel copyWith({
		...
		return Regmv6FormModel(
			...
			premiAdd: premiAdd ?? this.premiAdd,
			premiCasco: premiCasco ?? this.premiCasco,
			premiDiskon: premiDiskon ?? this.premiDiskon,
			premiNet: premiNet ?? this.premiNet,
			premiSubtotal: premiSubtotal ?? this.premiSubtotal,
			regmv6Id: regmv6Id ?? this.regmv6Id,
		);
	}
}
