...
class Historybayar2Model {
	...
	Historybayar2Model({required this.curr, required this.dn1Id, 
		required this.nilaiBayar, required this.polisNo, 
		required this.sppa1Id});

	factory Historybayar2Model.fromJson(Map<String, dynamic> data) {
		return Historybayar2Model(
			curr: data['curr']??'',
			dn1Id: data['dn1Id']??'',
