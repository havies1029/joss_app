...
class DnsppamvCariModel {
	...
	DnsppamvCariModel({required this.coverNama, required this.currDesc, 
	...
	factory DnsppamvCariModel.fromJson(Map<String, dynamic> data) {
		return DnsppamvCariModel(
