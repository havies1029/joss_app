class DnDetailSppaModel {
  ...
  factory DnDetailSppaModel.fromJson(Map<String, dynamic> data) {
    return DnDetailSppaModel(
      ...
      polisAkhir: data['polisAkhir'] == null || data['polisAkhir'].toString().isEmpty
          ? null
          : DateTime.tryParse(data['polisAkhir'].toString()),
      polisMulai: data['polisMulai'] == null || data['polisMulai'].toString().isEmpty
          ? null
          : DateTime.tryParse(data['polisMulai'].toString()),
