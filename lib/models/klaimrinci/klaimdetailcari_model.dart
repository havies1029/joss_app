...
class KlaimdetailCariModel {
	...
	KlaimdetailCariModel({required this.cobId, required this.cobNama, 
		required this.curr, required this.klaimAmount, 
		required this.klaim1Id, required this.noPolis, 
		required this.nourut, required this.statusDesc, 
