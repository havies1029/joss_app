...
class KlaimmvpoliscrudModel {
	...
	KlaimmvpoliscrudModel({required this.insuredNama, required this.isPolisJps, 
		required this.klaim1Id, required this.laporAsuransi, 
		required this.noChasis, required this.noPlat, 
		required this.polisAkhir, required this.polisMulai, 
		required this.polisNo, required this.sppa1Id, 
		this.minsurerId, this.comboMInsurer, this.mmvjnscoverId, this.comboMMvjnscover});
