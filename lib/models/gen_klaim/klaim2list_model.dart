...
class Klaim2ListModel {
	...
	Klaim2ListModel({required this.keterangan, required this.klaimAmountBaru, 
		required this.klaimAmountLama, required this.klaim1Id, 
		required this.klaim2Id, required this.mstsclaimId, 
		required this.perubahanTgl, required this.statusNama});
