...
class MRekanContactCrudModel {
	...
	MRekanContactCrudModel({required this.alamat1, required this.email, 
	...
	factory MRekanContactCrudModel.fromJson(Map<String, dynamic> data) {
		ComboMKotaModel? comboMKota;
