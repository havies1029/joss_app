...
class MRekanGeneralModel {
	...
	MRekanGeneralModel({required this.mrekan1Id, required this.rekanNama, 
	...
	factory MRekanGeneralModel.fromJson(Map<String, dynamic> data) {
		ComboMBentukCstModel? comboMBentukCst;
