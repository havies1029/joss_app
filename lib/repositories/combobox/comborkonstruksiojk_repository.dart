...
class ComboRKonstruksiojkRepository {
  Future<List<ComboRKonstruksiojkModel>> getComboRKonstruksiojk(
      String filter) async {
    ComboRKonstruksiojkAPI api = ComboRKonstruksiojkAPI();
    return await api.getComboRKonstruksiojkAPI(filter);
  }

  Future<List<ComboRKonstruksiojkModel>> getComboRKonstruksiojkOne() async {
    ComboRKonstruksiojkAPI api = ComboRKonstruksiojkAPI();
    return await api.getComboRKonstruksiojkOneAPI();
  }
}
